...
! --- this loops reads the snapshots saved by QSATS.
...
!     average of U(x,t)
!-----------------------------------------
!      subroutine ave_u(w,u,qu)
!      
!      use cdat, only: ntraj
!
!      implicit real*8(a-h,o-z)
!
!      real*8 :: w(ntraj),u(ntraj)
!
!      qu = 0d0
!
!      do i=1,ntraj
...
! ---------------------------------------------------------------
!      subroutine aver_par(ntraj_proc,w,x,y)
!
!      use cdat, only: ntraj
!
!      implicit real*8(a-h,o-z)
!
!      integer*4,intent(in) :: myid, ntraj_proc
!      real*8               :: x(Ntraj), w(Ntraj)
!
!      y = 0d0
!
!      do i=1,(myid+1)*ntraj_proc
!        y = y+x(i)*w(i)
!      enddo
!     
!      return
...
!      real*8, intent(out), dimension(ndim,ntraj) :: ap
...
!      do i = myid*ntraj_proc+1,(myid+1)*ntraj_proc
     ...
     +                  du_proc(j,i)-cf(j)*p_proc(j,i)/am(j))
     +                  *dt
...
!        call aver_par(ntraj_proc,w,pe,proc_po)
!        call aver(Ntraj_proc,w,ke,proc_enk)
!        call aver(Ntraj_proc,w,u, proc_qu)
